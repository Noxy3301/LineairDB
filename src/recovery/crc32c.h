...
/**
 * Test-only: forces the table or hardware path regardless of what the CPU
 * running the test supports. UpdateWithSse42ForTesting() falls back to the
 * table off x86 or without SSE4.2; check HasSse42ForTesting() to know which.
 */
